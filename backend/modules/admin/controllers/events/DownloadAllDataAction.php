...
class DownloadAllDataAction extends Action
{
     ...
     * @inheritdoc
     */
    public function run($user_id, $team_id, $event_id, $question_id)
    {
        $users = Users::findAll();
        $teams = Teams::findAll();
        ...
        (new Array2Xslsx(['AllCTFData' => $data]))->toDownload( . '.xlsx');
    }

    private function getAllData($user_id, $team_id, $event_id, $question_id)
    {
